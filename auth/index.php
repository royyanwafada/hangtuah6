    ...
    <div class="login-page">
        <div class="form">
            ...
            <form class="register-form">
                ...
                <input type="text" onkeyup="validHurufAngka(this)" placeholder="email address" />
            ...
            <form class="login-form" method="post" action="login_check.php">
                ...
                if (isset($_GET['failed'])) {
                    ...
                    echo '</script>';
                    echo "<p class=\"message\" ><strong>Username atau Password anda salah,</br>Silahkan coba lagi</strong></a></p>";
                }
