...
<head>
    ...
    <title>Teachers and Staff | SMP Hang Tuah 6 Excellent</title>
                    ...
                    <div class="row">
                        <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-9">
                            <div class="hero-caption hero-caption2">
                                ...
                                <p>SMP Hang Tuah 6 Excellent Juanda Sidoarjo</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="properties pb-30">
                            <div class="properties__card">
                                ...
                                <div class="properties__caption text-center">
                                    <h3><a href="#">Irra Fatukawati, S.Si., M.Si.</a></h3>
                                    <p>Kepala Sekolah</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img">
                                    <a href="#"><img src="pict/mufid.jpg" alt=""></a>
                                </div>
                                <div class="properties__caption text-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img">
                                    <a href="#"><img src="pict/nur.jpg" alt=""></a>
                                </div>
                                <div class="properties__caption text-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="properties pb-30">
                            <div class="properties__card">
                                <div class="properties__img">
                                    <a href="#"><img src="pict/yasinda.jpg" alt=""></a>
                                </div>
                                <div class="properties__caption text-center">
