...
<head>
    ...
    <title>Infrastructure | SMP Hang Tuah 6 Excellent</title>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="single-blogs">
                            <div class="blog-img">
                                <img src="../assets/img/gallery/lab.jpeg" alt="">
                            </div>
                        ...
                        <div class="single-blogs mb-30">
                            ...
                            <div class="blog-caption">
                                ...
                                <p>Desain Ruangan dengan konsep Smart Class dan dilengkapi dengan Panel LED Interactive.</p>
                                <!-- <a href="#" class="browse-btn">Learn More</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="single-blogs">
                            <div class="blog-img">
                                <img src="../assets/img/gallery/lounge.JPG" alt="">
                            </div>
                            <div class="blog-caption">
                                <h3><a href="#">Excellent Lounge</a></h3>
                                <p>Integer efficitur tellus metus, sed feugiat leo posuere ac. Morbi vitae tincidunt mi,
                                    et malesuada massa. Sed blandit placerat elit sit amet condimentum.</p>
                                <!-- <a href="#" class="browse-btn">Learn More</a> -->
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="../assets/img/gallery/perpus.jpeg" alt="">
                            </div>
                            <div class="blog-caption">
                                <h3><a href="#">Perpustakaan/Library</a></h3>
                                <p>Integer efficitur tellus metus, sed feugiat leo posuere ac. Morbi vitae tincidunt mi,
                                    et malesuada massa. Sed blandit placerat elit sit amet condimentum.</p>
                                <!-- <a href="#" class="browse-btn">Learn More</a> -->
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="../assets/img/gallery/ruangkepsek.jpg" alt="">
                            </div>
                            <div class="blog-caption">
                                <h3><a href="#">Ruang Kepala Sekolah</a></h3>
                                <p>Integer efficitur tellus metus, sed feugiat leo posuere ac. Morbi vitae tincidunt mi,
                                    et malesuada massa. Sed blandit placerat elit sit amet condimentum.</p>
                                <!-- <a href="#" class="browse-btn">Learn More</a> -->
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="../assets/img/gallery/suhu.jpg" alt="">
                            </div>
                            <div class="blog-caption">
                                <h3><a href="#">Pengukur Suhu</a></h3>
                                <p>Integer efficitur tellus metus, sed feugiat leo posuere ac. Morbi vitae tincidunt mi,
                                    et malesuada massa. Sed blandit placerat elit sit amet condimentum.</p>
                                <!-- <a href="#" class="browse-btn">Learn More</a> -->
                            </div>
